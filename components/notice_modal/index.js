        ...
        >
          <div className={styles.modalContent}>
            ...
            >
              <p>
                1.
                本專案創立於資策會，由本人和四位大神於就學期間一同打造，並由個人在後期進行維護和優化
              </p>
              <p>
                2. 網站目前可以進行帳號的創建, 以及商品的購物行為,
                目前開放區域為 "線上購物", "會員中心"。 其餘 課程的選購 和
                文章的閱讀 部分待後期維修完畢後, 逐漸開放。
              </p>
              <p>
                3. 在 IGotBrew 裡, 除了會員中心外, 其餘 ui 部分皆為小組共同創作,
                個人儘量以不破壞原則進行維護 (結構會處理, RWD 也盡量合併)
              </p>
              <p>4. 網頁目前進度: 商品後台的維護以及整合, 訂單狀態後台建置中</p>
